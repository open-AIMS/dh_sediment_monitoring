...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, colback=white, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, breakable, opacityback=0, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, left=2mm, coltitle=black, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, colback=white, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, breakable, opacityback=0, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{More specific information about the \texttt{deploy.bat} script}, left=2mm, coltitle=black, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacityback=0, colframe=quarto-callout-color-frame, rightrule=.15mm, colback=white, bottomrule=.15mm, left=2mm, toprule=.15mm, arc=.35mm, leftrule=.75mm]
