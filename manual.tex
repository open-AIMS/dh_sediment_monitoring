...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, arc=.35mm, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, left=2mm, coltitle=black, opacitybacktitle=0.6, opacityback=0, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, colback=white, leftrule=.75mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, arc=.35mm, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, left=2mm, coltitle=black, opacitybacktitle=0.6, opacityback=0, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, colback=white, leftrule=.75mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{More specific information about the \texttt{deploy.bat} script}, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colframe=quarto-callout-color-frame, toprule=.15mm, breakable, colback=white, left=2mm, leftrule=.75mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm]
