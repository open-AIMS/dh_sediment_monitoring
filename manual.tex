...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, opacitybacktitle=0.6, bottomtitle=1mm, opacityback=0, toptitle=1mm, breakable, colframe=quarto-callout-note-color-frame, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colback=white, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, opacitybacktitle=0.6, bottomtitle=1mm, opacityback=0, toptitle=1mm, breakable, colframe=quarto-callout-note-color-frame, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{More specific information about the \texttt{deploy.bat} script}, colback=white, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, left=2mm]
...
\pandocbounded{\includegraphics[keepaspectratio]{manual_files/figure-pdf/fig-standardisations-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, opacitybacktitle=0.6, bottomtitle=1mm, opacityback=0, toptitle=1mm, breakable, colframe=quarto-callout-note-color-frame, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Bayesian hierarchical models}, colback=white, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, left=2mm]
...
parameters. The values (\(\alpha_1\), \(\alpha_2\) and \(\alpha_3\))
used to define the weakly informative priors were developed from simple
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, toprule=.15mm, opacityback=0, rightrule=.15mm, arc=.35mm, breakable, colframe=quarto-callout-color-frame, leftrule=.75mm, left=2mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, opacitybacktitle=0.6, bottomtitle=1mm, opacityback=0, toptitle=1mm, breakable, colframe=quarto-callout-important-color-frame, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, colback=white, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, left=2mm]
