...
Data standardisation rules are summarised in @fig-standardisations.
In the case of Fe/Al standardisations:
...
3. According to the threshold of Fe/Al < 1.3, each sample is tagged
...
5. During the step above, if the standardisation of an individual
